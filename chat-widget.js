...
(() => {
 ...
 <label class="tschat-consent"><input type="checkbox" name="consent" required><span>I agree to TechSpan storing my contact details and messages in Cloudflare to respond to this enquiry. Chats are removed after 30 days of inactivity when scheduled cleanup is enabled. Do not share passwords, payment details or sensitive information. Read our <a href="privacy.html" target="_blank" rel="noopener">Privacy Policy</a>.</span></label>
